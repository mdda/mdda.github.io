...
we don't know how the software should be writen - 
...
But it has not been built to be
re-engineered.  It is very difficult to find the organising principles.
And it's often very easy to see them in hind-sight : Backpropagation learning, with
hindsight, is a very, very simple phenomenon, but it took mankind a  very long time
to hit upon the principle of Backpropagation learning - I guess we have 
a few hundred problems on the difficulty level of Backpropagation learning to solve

...
Given the recent successes of Deep Learning, it seems reasonable to assume 
that Backpropagation learning should be one of these organisational principles.  
However, this short communication argues that the lessons to be learned from 
